...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name, county_votes in counties_dict.items():
        ...
        if (county_votes > largest_county_voter_turnout) and (county_vote_percentage > winning_percentage):
    ...
    winning_county_summary = (
        f"------------------\n"
        f"Largest Turnout: {largest_county_name}\n"
        f"------------------\n")   
